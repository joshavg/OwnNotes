...
class GenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this->setDefinition(array(
            ...
            ->setDescription('Generates a CRUD based on a Doctrine entity in bootstrap style')
            ->setHelp(<<<EOT
...
EOT
            ...
            ->setName('doctrine:generate:crud:bootstrap')
            ->setAliases(array(
            'doctrine:generate:crud:bootstrap'
        ));
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $entityClass = $this->getContainer()
            ->get('doctrine')
            ->getAliasNamespace($bundle) . '\\' . $entity;
    ...
    {
        $prefix = $input->getOption('route-prefix') ?  : strtolower(str_replace(array(
            '\\',
            '/'
        ), '_', $entity));
